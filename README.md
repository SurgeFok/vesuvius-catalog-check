...
This runs ten structural checks over that catalog in well under a second, with no
...
| `data-format-mixed` | [#1654](https://github.com/ScrollPrize/villa/issues/1654) | one sample publishes volumes in mixed integer widths |
